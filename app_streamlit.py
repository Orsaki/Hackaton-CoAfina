...
# -----------------------------------------------------
# --- DICCIONARIO DE ESTADÍSTICAS GLOBALES PARA EL CHATBOT ---
# -----------------------------------------------------
STATION_STATS_DATA = {
...
with st.sidebar:
    ...
    menu = option_menu(
        ...
        options=[
            "Inicio",
            "Mapa de Estaciones",
            "Análisis por Estación", # Animación eliminada
            "Chatbot",
            "Equipo"
        ],
        icons=[
...
# -----------------------------------------------
# SECCIÓN: MAPA DE ESTACIONES (¡ACTUALIZADA A PLOTLY SIMPLE!)
# -----------------------------------------------
...
# -----------------------------------------------
# SECCIÓN: ANIMACIÓN DE DATOS (ELIMINADA)
# -----------------------------------------------
# ... (Sección eliminada)
